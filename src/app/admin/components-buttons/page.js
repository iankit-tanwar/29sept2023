                      ...
                      <div className="col-lg-6">
                          ...
                          <div className="card">
                              <div className="card-body">
                                  ...
                                  <button type="button" className="btn btn-primary"><i className="bi bi-star me-1" /> With Text</button>
                                  <button type="button" className="btn btn-secondary"><i className="bi bi-collection" /></button>
                                  <button type="button" className="btn btn-success"><i className="bi bi-check-circle" /></button>
                                  <button type="button" className="btn btn-danger"><i className="bi bi-exclamation-octagon" /></button>
                                  <button type="button" className="btn btn-warning"><i className="bi bi-exclamation-triangle" /></button>
                                  <button type="button" className="btn btn-info"><i className="bi bi-info-circle" /></button>
                                  <button type="button" className="btn btn-dark"><i className="bi bi-folder" /></button>
                              </div>
                          </div>
                          <div className="card">
                              <div className="card-body">
                      ...
                      <div className="col-lg-6">
                          ...
                          <div className="card">
                              <div className="card-body">
                                  ...
                                  <button type="button" className="btn btn-secondary">Normal</button>
                                  <button type="button" className="btn btn-success btn-lg">Large</button>
                                  <button type="button" className="btn btn-outline-danger btn-sm">Small</button>
                                  <button type="button" className="btn btn-outline-warning">Normal</button>
                                  <button type="button" className="btn btn-outline-info btn-lg">Large</button>
                          ...
                          <div className="card">
                              <div className="card-body">
                                  ...
                                  <button type="button" className="btn btn-outline-primary">Normal</button>
                                  <button type="button" className="btn btn-outline-primary" disabled>Disabled</button>
                              </div>
                          </div>
                      </div>
                  </div>

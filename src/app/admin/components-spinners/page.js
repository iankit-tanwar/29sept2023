                      ...
                      <div className="col-lg-6">
                          ...
                          <div className="card">
                              <div className="card-body">
                                  ...
                                  <div className="spinner-border" style={{ width: 30, height: 30 }} role="status">
                                      <span className="visually-hidden">Loading...</span>
                                  </div>
                                  ...
                                  <div className="spinner-grow" style={{ width: 30, height: 30 }} role="status">
                                      <span className="visually-hidden">Loading...</span>
                                  </div>
                                  <div className="spinner-grow" style={{ width: 40, height: 40 }} role="status">
                                      <span className="visually-hidden">Loading...</span>
                                  </div>

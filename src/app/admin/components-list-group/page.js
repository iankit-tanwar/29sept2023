                      ...
                      <div className="col-lg-6">
                          ...
                          <div className="card">
                              <div className="card-body">
                                  ...
                                  <ul className="list-group">
                                      <li className="list-group-item"><i className="bi bi-star me-1 text-success" /> An item</li>
                                      <li className="list-group-item"><i className="bi bi-collection me-1 text-primary" /> A second item</li>
                                      <li className="list-group-item"><i className="bi bi-check-circle me-1 text-danger" /> A third item</li>
                                      <li className="list-group-item"><i className="bi bi-exclamation-octagon me-1 text-warning" /> A fourth item</li>

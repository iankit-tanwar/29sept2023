                              ...
                              <div className="card-body">
                                  ...
                                  <form>
                                      ...
                                      <div className="row mb-3">
                                          ...
                                          <div className="col-sm-10">
                                              <input type="color" className="form-control form-control-color" id="exampleColorInput" defaultValue="#4154f1" title="Choose your color" />
                                          </div>
                                      </div>
                                      <div className="row mb-3">
                                          <label htmlFor="inputPassword" className="col-sm-2 col-form-label">Textarea</label>
                                          <div className="col-sm-10">
                                              <textarea className="form-control" style={{ height: 100 }} defaultValue={""} />
                                          </div>
                                      </div>
                                      <fieldset className="row mb-3">
                                          ...
                                          <div className="col-sm-10">
                                              ...
                                              <div className="form-check disabled">
                                                  <input className="form-check-input" type="radio" name="gridRadios" id="gridRadios" defaultValue="option" disabled />
